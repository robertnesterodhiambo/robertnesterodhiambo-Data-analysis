...
### Lets vizualize Historical Bitcoin Market Volume (2015-2018)-Yearly
...
Epochs are the number of times the data is being trained
...
train(model, X_train, y_train, epochs = 100, lr = 0.001)  # epochs are set to 100
```
