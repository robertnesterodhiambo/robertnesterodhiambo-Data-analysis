...
data_dir <- "C:/Users/HP/RRproject_BTC/BTC_data"
...
file_path <- "C:/Users/HP/RRproject_BTC/BTC_data/coinbaseUSD_1-min_data_2014-12-01_to_2018-11-11.csv"

# Read the CSV file into a data frame named 'data'
data <- read_csv("C:/Users/HP/RRproject_BTC/BTC_data/coinbaseUSD_1-min_data_2014-12-01_to_2018-11-11.csv")
...
![python output](images/clipboard-4093958283.png)
...
![python fig2](images/clipboard-2840284354.png)
...
![](images/clipboard-2935226500.png)
...
```{r, message=FALSE}
data <- read_csv("C:/Users/HP/RRproject_BTC/BTC_data/bitstampUSD_1-min_data_2012-01-01_to_2018-11-11.csv")  # Read CSV data into 'data' dataframe
data <- data %>% 
...
The model trained with Prophet in R has an MAE of 625.8949 and an RMSE of 1025.923, while the Prophet model in Python has an MAE of 1678.49 and an MSE of 3654149.48. Since both MAE and RMSE are significantly lower for the Prophet model, it indicates better prediction accuracy and fewer large errors. Thus, the Prophet model in R is the better choice for this data set.
